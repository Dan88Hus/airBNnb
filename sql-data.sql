...
CREATE TABLE  `facilityRate` (
  ...
  CONSTRAINT `fk_facilityRate_2`
    ...
    REFERENCES `userRole` (`id_userRole`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='to keep record of facility order of guest';



-- ----------------------------------------------------
-- Table `facilityInvoice`
-- -----------------------------------------------------
...
CREATE TABLE `facilityInvoice` (
  ...
  KEY `fk_facilityInvoice_1_idx` (`dailyPrice`),
  KEY `fk_facilityInvoice_2_idx` (`fk_facilityId`),
  KEY `fk_facilityInvoice_3_idx` (`fk_facilityTaxRateId`),
  CONSTRAINT `fk_facilityInvoice_1` FOREIGN KEY (`dailyPrice`) REFERENCES `facilityPrice` (`id_facilityPrice`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_facilityInvoice_2` FOREIGN KEY (`fk_facilityId`) REFERENCES `facility` (`id_facility`),
  CONSTRAINT `fk_facilityInvoice_3` FOREIGN KEY (`fk_facilityTaxRateId`) REFERENCES `facilityTaxRate` (`id_facilityTaxRate`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE  `expectedIncome` (
  ...
  CONSTRAINT `fk_expectedIncome_2`
    ...
    REFERENCES `facilityPrice` (`id_facilityPrice`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_expectedIncome_3`
    FOREIGN KEY (`fk_facilityOrderId`)
    REFERENCES `facilityOrder` (`id_facilityOrder`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
CREATE TABLE  `carrier` (
  ...
  CONSTRAINT `fk_carrier_2`
    ...
    REFERENCES `facilityInvoice` (`id_facilityInvoice`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `accountReceivable_has_facilityInvoice`
-- -----------------------------------------------------
CREATE TABLE  `accountReceivable_has_facilityInvoice` (
  ...
  CONSTRAINT `fk_accountReceivable_has_facilityInvoice_accountReceivable1`
    ...
    REFERENCES `accountReceivable` (`id_acctReceivable`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `facilityInvoice_has_accountPayable`
-- -----------------------------------------------------
CREATE TABLE  `facilityInvoice_has_accountPayable` (
  ...
  CONSTRAINT `fk_facilityInvoice_has_accountPayable_accountPayable1`
    ...
    REFERENCES `accountPayable` (`id_acctPayable`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
